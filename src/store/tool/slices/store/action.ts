import { JtChatPluginsMarketIndex } from '@lobehub/chat-plugin-sdk';
...
export interface PluginStoreAction {
  ...
  loadPluginStore: () => Promise<JtChatPluginsMarketIndex>;
  ...
  useFetchPluginStore: () => SWRResponse<JtChatPluginsMarketIndex>;
}
...
> = (set, get) => ({
  ...
  useFetchPluginStore: () =>
    useSWR<JtChatPluginsMarketIndex>('loadPluginStore', get().loadPluginStore),
});

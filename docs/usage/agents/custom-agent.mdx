---
title: Custom JtChat Assistant Guide - Adding and Iterating Assistants
description: >-
  Learn how to add assistants to your favorites list in JtChat through the
...
As the basic functional unit of JtChat, adding and iterating assistants is very important. Now you can add assistants to your favorites list in two ways.

## `A` Add through the role market

If you are a beginner in Prompt writing, you might want to browse the assistant market of JtChat first. Here, you can find commonly used assistants submitted by others and easily add them to your list with just one click, which is very convenient.

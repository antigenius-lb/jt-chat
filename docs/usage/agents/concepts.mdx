---
title: Improving User Interaction Efficiency with Agents in JtChat
description: >-
  Discover how JtChat's innovative approach with Agents enhances user
...
Therefore, in JtChat, we have introduced the concept of **Agents**. An agent is a complete functional module, each with its own responsibilities and tasks. Assistants can help you handle various tasks and provide professional advice and guidance.

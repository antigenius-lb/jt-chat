---
title: Using Google Gemma Model in JtChat
description: >-
  Learn how to integrate and utilize Google Gemma in JtChat, an open-source
  large language model, in JtChat with the help of Ollama. Follow these steps
...
<Image
  alt={'Using Gemma in JtChat'}
  cover
  src={'https://github.com/lobehub/lobe-chat/assets/28616219/e636cb41-5b7f-4949-a236-1cc1633bd223'}
/>

[Gemma](https://blog.google/technology/developers/gemma-open-models/) is an open-source large language model (LLM) from Google, designed to provide a more general and flexible model for various natural language processing tasks. Now, with the integration of JtChat and [Ollama](https://ollama.com/), you can easily use Google Gemma in JtChat.

This document will guide you on how to use Google Gemma in JtChat:
...
Now, you can start conversing with the local Gemma model using JtChat.

---
title: Using Ollama in JtChat
description: >-
  Learn how to use Ollama in JtChat, run LLM locally, and experience
...
# Using Ollama in JtChat

<Image
  alt={'Using Ollama in JtChat'}
  borderless
  cover
  src={'https://github.com/lobehub/lobe-chat/assets/28616219/a2a091b8-ac45-4679-b5e0-21d711e17fef'}
/>

Ollama is a powerful framework for running large language models (LLMs) locally, supporting various language models including Llama 2, Mistral, and more. Now, JtChat supports integration with Ollama, meaning you can easily enhance your application by using the language models provided by Ollama in JtChat.

This document will guide you on how to use Ollama in JtChat:

<Video
  alt="demonstration of using Ollama in JtChat"
  height={580}
...
### Conversing with Local Large Models in JtChat

Now, you can start conversing with the local LLM in JtChat.

<Image
  alt="Chat with llama3 in JtChat"
  height="573"
...
### Installation in JtChat

In JtChat, we have enabled some common large language models by default, such as llama3, Gemma, Mistral, etc. When you select a model for conversation, we will prompt you to download that model.

<Image
  alt="JtChat guide your to install Ollama model"
  height="460"
...
<Callout type={'info'}>
  ...
  JtChat to meet integration needs with Ollama.
</Callout>

---
title: JtChat support Speech Synthesis and Recognition (TTS & STT)
description: >-
  Experience seamless Text-to-Speech (TTS) and Speech-to-Text (STT) technologies
  in JtChat. Choose from a variety of high-quality voices for personalized
...
<Callout type={'info'}>
  During the implementation of the TTS feature in JtChat, we found that there was no good frontend

---
title: JtChat support Progressive Web Apps (PWA)
description: >-
  Discover how JtChat utilizes Progressive Web App (PWA) technology to provide
  a seamless and near-native app experience on both desktop and mobile devices.
  Learn how to install JtChat as a desktop app for enhanced convenience.
tags:
  - Progressive Web App
  - PWA
  - JtChat
...
<Callout type={'tip'}>
  The default installed JtChat PWA icon has a black background, you can use <kbd>cmd</kbd> + <kbd>i</kbd> to paste the following image to replace it with a white background.
</Callout>

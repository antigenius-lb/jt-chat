---
title: Deploy JtChat with Netlify - Step-by-Step Guide
description: >-
  Learn how to deploy JtChat on Netlify with detailed instructions on forking
...
# Deploy JtChat with Netlify

If you want to deploy JtChat on Netlify, you can follow these steps:

## Deploy JtChat with Netlify

<Steps>
  ### Fork the JtChat Repository

Click the Fork button to fork the JtChat repository to your GitHub account.
...
Next, select the JtChat project:

<Image
  alt={'Select the JtChat github project'}
  height={228}
  inStep
...
<Image
  alt={'Configure JtChat site name'}
  height={712}
  inStep
...
<Image
  alt={'Add JtChat site environment variables'}
  height={537}
  inStep
...
<Callout type={'tip'}>
  For a complete list of environment variables supported by JtChat, please refer to the [📘
...
Upon entering the deployment details, you will see the following interface, indicating that your JtChat is currently being deployed. Simply wait for the deployment to complete.

<Image
  alt={'JtChat deployment in progress'}
  height={325}
  inStep
...
If your Deploy Log in the interface looks like the following, it means your JtChat has been successfully deployed.
...
At this point, you can click on "Open production deploy" to access your JtChat site.

  <Image alt={'Access Your JtChat Site'} height={527} inStep src={'https://github.com/lobehub/lobe-chat/assets/28616219/b04723eb-64ad-4028-a901-dc4e4ee2d0c1'} />
</Steps>

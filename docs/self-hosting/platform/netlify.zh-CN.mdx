---
title: 在 Netlify 上部署 JtChat
description: >-
  学习如何在 Netlify 上部署 JtChat，包括 Fork 仓库、准备 OpenAI API Key、导入到 Netlify
  工作台、配置站点名称与环境变量等步骤。
tags:
  - Netlify
  - JtChat
...
如果想在 Netlify 上部署 JtChat，可以按照以下步骤进行操作：
...
点击 Fork 按钮，将 JtChat 仓库 Fork 到你的 GitHub 账号下。
...
<Callout type={'tip'}>
  JtChat 支持的完整环境变量列表请参考 [📘 环境变量](/docs/self-hosting/environment-variables) 部分
</Callout>
...
进入部署详情，你会看到下述界面，这意味着你的 JtChat 正在部署中，只需等待部署完成即可。
...
如果你的界面中的 Deploy Log 如下所示，意味着你的 JtChat 部署成功了。
...
此时，你可以点击「Open production deploy」，即可访问你的 JtChat 站点

  <Image alt={'访问你的 JtChat 站点'} height={527} inStep src={'https://github.com/lobehub/lobe-chat/assets/28616219/b04723eb-64ad-4028-a901-dc4e4ee2d0c1'} />
</Steps>

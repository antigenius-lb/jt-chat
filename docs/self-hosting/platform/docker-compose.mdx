---
title: Deploy JtChat with Docker Compose
description: >-
  Learn how to deploy the JtChat service using Docker Compose. Follow
...
We provide a [Docker image][docker-release-link] for deploying the JtChat service on your private device.

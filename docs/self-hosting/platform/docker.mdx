---
title: Deploy JtChat with Docker
description: >-
  Learn how to deploy the JtChat service using Docker, including installation
...
We provide a [Docker image][docker-release-link] for you to deploy the JtChat service on your private device.
...
Use the following command to start the JtChat service with one click:
...
- For the complete list of environment variables supported by JtChat, please refer to the [Environment Variables](/docs/self-hosting/environment-ariable) section.

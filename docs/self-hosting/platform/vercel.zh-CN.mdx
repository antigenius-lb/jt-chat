---
title: 在 Vercel 上部署 JtChat
description: 学习如何在 Vercel 上一键部署 JtChat，准备 OpenAI API Key，点击按钮进行部署，绑定自定义域名，自动同步更新等。
tags:
  - Vercel
  - 部署指引
  - JtChat
...
如果想在 Vercel 上部署 JtChat，可以按照以下步骤进行操作：
...
<Callout>
  我们建议按照 [📘 JtChat 自部署保持更新](/docs/self-hosting/advanced/upstream-sync) 步骤重新部署。
</Callout>

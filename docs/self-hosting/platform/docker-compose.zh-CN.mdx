---
title: 通过 Docker Compose 部署 JtChat
description: 学习如何使用 Docker Compose 部署 JtChat 服务，包括安装 Docker 容器环境和自动更新脚本设置。
tags:
  - Docker Compose
  - JtChat
  - Docker 容器
...
我们提供了 [Docker 镜像](https://hub.docker.com/r/lobehub/lobe-chat) ，供你在自己的私有设备上部署 JtChat 服务。

---
title: 通过 Docker 部署 JtChat
description: 学习如何使用 Docker 部署 JtChat 服务，包括安装 Docker 容器环境和使用指令一键启动服务。详细说明如何配置环境变量和使用代理地址。
tags:
  - Docker
  - JtChat
  - 部署指引
...
我们提供了 [Docker 镜像][docker-release-link]，供你在自己的私有设备上部署 JtChat 服务。

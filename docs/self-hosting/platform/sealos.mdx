---
title: Deploy JtChat on SealOS
description: >-
  Learn how to deploy JtChat on SealOS with ease. Follow the provided steps to
  set up JtChat and start using it efficiently.
tags:
  - Deploy JtChat
  - SealOS Deployment
  - OpenAI API Key
...
# Deploy JtChat with SealOS

If you want to deploy JtChat on SealOS, you can follow the steps below:

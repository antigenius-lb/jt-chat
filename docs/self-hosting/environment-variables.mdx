---
title: JtChat Environment Variables - Customizing Guide
description: >-
  Learn how to customize JtChat configuration using environment variables for
...
JtChat provides some additional configuration options when deployed, which can be customized using environment variables.

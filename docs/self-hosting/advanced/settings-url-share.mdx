...
JtChat support import settings from external URL to quickly set up JtChat configuration.
...
<Callout type={'warning'}>
    JtChat does not verify the correctness of the settings parameters in the URL, nor provide encryption or decryption methods. Please use with caution.
</Callout>

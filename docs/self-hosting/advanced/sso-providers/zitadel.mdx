---
title: Configure ZITADEL Authentication Service for JtChat
description: >-
  Learn how to configure ZITADEL Authentication Service for JtChat deployment,
...
<Callout type={'important'}>
  ...
  - Replace `http(s)://your-domain` with the actual URL that JtChat is deployed to.
</Callout>
...
<Callout>
  After successful deployment, users will be able to authenticate and use JtChat using existing

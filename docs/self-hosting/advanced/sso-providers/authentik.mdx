---
title: Configuring Authentik Authentication Service for JtChat
description: >-
  Learn how to configure Authentik for Single Sign-On (SSO) for JtChat,
  including creating an application provider, setting environment variables, and
  deployment instructions.
tags:
  - Authentik Configuration
  - Single Sign-On (SSO)
  - JtChat Authentication
...
<Callout type={'info'}>
  After a successful deployment, users will be able to use JtChat by authenticating with the users

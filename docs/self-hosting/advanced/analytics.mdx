---
title: Integrating Data Analytics Services in JtChat for User Usage Analysis
description: >-
  Learn how to integrate free/open-source data analytics services in JtChat to
...
To better help analyze the usage of JtChat users, we have integrated several free/open-source data analytics services in JtChat for collecting user usage data, which you can enable as needed.

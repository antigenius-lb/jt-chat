---
title: Integrating JtChat with Ollama for Enhanced Language Models
description: >-
  Learn how to configure and deploy JtChat to leverage Ollama's powerful
  language models locally. Follow the guide to run Ollama and JtChat on your
  system.
tags:
  - Ollama integration
  - JtChat configuration
  - Local deployment
  - Language models
  - Ollama usage
---
...
Ollama is a powerful framework for running large language models (LLMs) locally, supporting various language models including Llama 2, Mistral, and more. Now, JtChat supports integration with Ollama, meaning you can easily use the language models provided by Ollama to enhance your application within JtChat.

This document will guide you on how to configure and deploy JtChat to use Ollama:
...
## Running JtChat Locally

Assuming you have already started the Ollama service locally on port `11434`. Run the following Docker command to start JtChat locally:

```bash
docker run -d -p 3210:3210 -e OLLAMA_PROXY_URL=http://host.docker.internal:11434/v1 lobehub/lobe-chat
```

Now, you can use JtChat to converse with the local LLM.

For more information on using Ollama in JtChat, please refer to [Ollama Usage](/docs/usage/providers/ollama).
